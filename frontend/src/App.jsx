                          ...
                          {layer.components.map((comp) => (
                            <div key={comp.name} className="bg-slate-700/50 rounded-lg p-3">
                              <div className="flex justify-between items-start mb-1 gap-2">
                                ...
                                <span className="text-xs bg-purple-600 px-2 py-1 rounded shrink-0">{comp.tech}</span>
                              </div>
                ...
                <div className="grid grid-cols-1 gap-4">
                  {formulas.map((formula) => (
                    <div key={formula.id} className="bg-gradient-to-r from-slate-800/50 to-blue-900/20 border border-blue-500/30 rounded-lg p-5">
                      ...
                      <div className="bg-slate-900/50 rounded p-3 mb-3 font-mono text-sm text-green-400 overflow-x-auto">
                        {formula.formula}
                      </div>
